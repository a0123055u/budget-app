"""
Django settings for budgetcore project.
...
SECRET_KEY = 'django-insecure-lor@p%fdrnxxiqy+uxh30z4l6m%%8nv=+a45d=^ims)*bbeb4$'
...
WSGI_APPLICATION = 'budgetcore.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'icons'),  # Adjust as needed
]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_RENDERER_CLASSES': (
        ...
        'rest_framework.renderers.BrowsableAPIRenderer',  # Enables API UI
    ),
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticated',  # Change to 'AllowAny' to allow all
    ],
}
